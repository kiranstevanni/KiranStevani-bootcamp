...
const CartModal = ({ handleHideModalCart }) => {
  ...
  const handleCheckoutToWhatsapp = () => {
    ...
    const phoneNumber = "6281567961445";
    ...
    <Modal>
      <div className="flex flex-col gap-6 p-1: sm:p-2 w-full lg:w-[900px]">
        ...
        <div className="flex items-center justify-between">
          <button
            type="button"
            className="bg-black hover:bg-slate-800 text-white py-3 px-8 rounded-xl text-sm"
          ...
          <button
            type="button"
            className="bg-primary hover:bg-slate-800 text-white font-bold py-3 px-8 rounded-xl text-sm"
